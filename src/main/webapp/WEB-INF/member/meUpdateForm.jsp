				...
				<form:form modelAttribute="member" class="form-horizontal" role="form" name="myform" action="${apppath}/update.me"  method="post">
					<div class="form-group">
	        			...
	        			<div class="col-xs-<%=formright-2%> col-lg-<%=formright-2%>">
	            			...
	            			<form:input path="id" type="text" name="fakeid" id="fakeid" class="form-control" 
	            				...
	            				<!-- disabled 로 해놓으면 파라미터로 절대로 안 넘어간다. hidden으로 한번 더 써줘야 함 --> 
					...
					<div class="form-group">
	        			...
	        			<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
	            			...
	            			<input type="text" name="hiredate" id="hiredate" class="form-control" placeholder="입사 일자" 
	            			value="${requestScope.bean.hiredate}" >
	            			<fmt:parseDate value="${active.expire_time}" pattern="yyyy-MM-dd" var="myDate"/>
